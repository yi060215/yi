...
#define BSP_FEATURE_SCI_UART_CSTPEN_CHANNELS_MASK            BSP_FEATURE_SCI_UART_CSTPEN_CHANNELS
#define BSP_FEATURE_SCI_UART_FIFO_CHANNELS_MASK              BSP_FEATURE_SCI_UART_FIFO_CHANNELS
#define BSP_FEATURE_SCI_ADDRESS_MATCH_CHANNELS_MASK          BSP_FEATURE_SCI_ADDRESS_MATCH_CHANNELS
#define BSP_FEATURE_SCI_UART_ABCSE_RESTRICTED_CHANNELS_MASK  (0U)
