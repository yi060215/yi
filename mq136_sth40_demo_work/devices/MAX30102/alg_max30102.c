                                            ...
                                            int8_t  *pch_hr_valid)
{
    ...
    /* Hamming window - flip waveform for valley detection by peak detector */
    ...
    if (n_npks >= 2) {
        ...
        *pn_heart_rate = (int32_t)(1500 / n_peak_interval_sum);  /* calibrated */
        *pch_hr_valid = 1;
    } else {
        *pn_heart_rate = -999;
        *pch_hr_valid = 0;
    ...
    /* Calculate ratio between AC of Ir & Red and DC of Ir & Red for SpO2 */
    n_ratio_average = 0;
    n_i_ratio_count = 0;
